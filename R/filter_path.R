...
filter_path <- function(file_path, filter_text = "^$|pattern"){
  events_path <- file_path[stringr::str_detect(file_path,"events.csv") &
  ...
  gluc_path <- file_path[stringr::str_detect(file_path,"gluc.csv") &
                           !stringr::str_detect(file_path,stringr::regex("Archive|Archives|Transfer|Transfers",ignore_case = T)) & !stringr::str_detect(file_path,stringr::regex(filter_text,ignore_case = T))]

  glucPlus_path <- file_path[stringr::str_detect(file_path,"glucPlus.csv") &
                               !stringr::str_detect(file_path,stringr::regex("Archive|Archives|Transfer|Transfers",ignore_case = T)) & !stringr::str_detect(file_path,stringr::regex(filter_text,ignore_case = T))]

  free_path <- file_path[stringr::str_detect(file_path,stringr::regex("freestyle.csv",ignore_case = T)) &
                           !stringr::str_detect(file_path,stringr::regex("Archive|Archives|Transfer|Transfers",ignore_case = T)) & !stringr::str_detect(file_path,stringr::regex(filter_text,ignore_case = T))]

  anaPlus_path <- file_path[stringr::str_detect(file_path,stringr::regex("anaPlus.csv",ignore_case = T)) &
                           !stringr::str_detect(file_path,stringr::regex("Archive|Archives|Transfer|Transfers",ignore_case = T)) & !stringr::str_detect(file_path,stringr::regex(filter_text,ignore_case = T))]

  oneMinutes_path <- file_path[stringr::str_detect(file_path,stringr::regex("oneMinutes.csv",ignore_case = T)) &
                              !stringr::str_detect(file_path,stringr::regex("Archive|Archives|Transfer|Transfers",ignore_case = T)) & !stringr::str_detect(file_path,stringr::regex(filter_text,ignore_case = T))]
