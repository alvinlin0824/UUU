...
#' @param transpose Transpose table. Default is NULL
...
system_agreement <- function(data, type = "Glucose", breakpoint = 70, ref, cgm, unit = "mg/dL",group_var, transpose = NULL, wider_name = NULL) {
