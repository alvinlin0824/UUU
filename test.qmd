...
Ap_mmol |>
   ...
   # filter(Day <= 15) |> 
   # filter(between(Gl,40,400)) |> 
   diff_measure_fun(type = "Glucose",breakpoint = 5.6,ref = Reference_mmol, cgm = Gl_mmol, col_subject = `Subject ID` ,group_var = c("Sensor","Glucose Level(mg/dL) [mmol/L]"), unit = "mmol/L",reference_breakpoint = F)
```
...
system_agreement_fun <- function(data, type = "Glucose", ref, cgm, unit = "mg/dL",group_var, breakpoint = 70, long = T, wider_name = NULL) {
...
Ap_ketone |> 
      ...
      system_agreement_fun(type = "Ketone",wider_name = `Ref Type`,ref = KRSEQ01, cgm = ANA, unit = "mmol/L",long = T, group_var = c("Site","Ref Type"), breakpoint = 70)
```
...
Ap_ketone |> 
      ...
      # mutate(Site = factor(Site, levels = c("Yale","RCR","Overall"))) |> 
      filter(between(ANA,0.6,3)) |> 
      system_agreement_fun(type = "Ketone",wider_name = NULL,ref = KRSEQ01, cgm = ANA, unit = "mmol/L",long = F, group_var = c("Site","Ref Type"), breakpoint = 70)
```
...
#| column: page
Ap_mmol |>
        system_agreement_fun(wider_name = Sensor,ref = Reference_mmol, cgm = Gl_mmol, unit = "mmol/L",long = T, group_var = c("Sensor"), breakpoint = 70)
```
...
#| column: page
Ap_mmol |>
        system_agreement_fun(wider_name = `Glucose Level(mg/dL) [mmol/L]`,ref = Reference_mmol, cgm = Gl_mmol, unit = "mmol/L",long = F, group_var = c("Sensor","Glucose Level(mg/dL) [mmol/L]"), breakpoint = 70)
```
...
#| column: page
Ap_mmol |>
        system_agreement_fun(wider_name = NULL,ref = Reference_mmol, cgm = Gl_mmol, unit = "mmol/L",long = F, group_var = c("Sensor","Day"), breakpoint = 70)
```
...
haven::read_sas("adc21206_paired_ca.sas7bdat") |> 
   filter(nday <= 15) |> 
   filter(between(cgm_rslt,40,400)) |> 
   system_agreement_fun(wider_name = ref_type, ref = ref_rslt, cgm = cgm_rslt, long = T, group_var = c("age_grp","ref_type"), breakpoint = 70)
```
...
Ap |> 
   filter(between(Gl,40,400)) |>
   system_agreement_fun(wider_name = `Reference Type`,ref = Reference, cgm = Gl, unit = "mg/dL",long = F, group_var = c("Age Group","Reference Type"), breakpoint = 70)
```
...
haven::read_sas("adc21206_paired_ca.sas7bdat") |> 
   filter(nday <= 15) |> 
   filter(between(cgm_rslt,40,400)) |> 
   system_agreement_fun(wider_name = NULL, ref = ref_rslt, cgm = cgm_rslt, long = F, group_var = c("age_grp","ref_type"), breakpoint = 80)
```
...
Ap |> 
   filter(between(Gl,40,400)) |> 
   system_agreement_fun(wider_name = NULL,long = F,ref = Reference, cgm = Gl, group_var = c("Age Group","Reference Type"),breakpoint = 80)
```
...
haven::read_sas("adc21206_paired_ca.sas7bdat") |>
   ...
   filter(nday <= 15) |>
   filter(between(cgm_rslt,40,400)) |>
   system_agreement_fun(wider_name = NULL, ref = ref_rslt, cgm = cgm_rslt, long = F, group_var = c("age_grp","ref_type","Ref. Glucose Level"), breakpoint = 70)
```
...
Ap |> 
   ...
   filter(between(Gl,40,400)) |>
   system_agreement_fun(wider_name = NULL,long = F,ref = Reference, cgm = Gl,group_var = c("Age Group","Reference Type","Ref. Glucose Level"),breakpoint = 70)
```
...
Ap |> 
   ...
   filter(between(Gl,40,400)) |>
   system_agreement_fun(wider_name = NULL,long = F,ref = Reference, cgm = Gl,group_var = c("Age Group","Reference Type","CGM Glucose Level"),breakpoint = 70)
```
...
haven::read_sas("adc21206_paired_ca.sas7bdat") |>
   ...
   filter(nday <= 15) |>
   filter(between(cgm_rslt,40,400)) |>
   system_agreement_fun(wider_name = trt_type, ref = ref_rslt, cgm = cgm_rslt, long = T, group_var = c("age_grp","ref_type","trt_type"), breakpoint = 70)
```
...
Ap |> 
   ...
   system_agreement_fun(wider_name = `Insulin Therapy`,long = T, ref = Reference, cgm = Gl,group_var = c("Age Group","Reference Type","Insulin Therapy"),breakpoint = 70)
```
...
Ap |> 
   filter(between(Gl,40,400)) |>
   # filter(`Reference Type` == "YSI") |> 
   system_agreement_fun(wider_name = NULL,long = F, ref = Reference, cgm = Gl, group_var = c("Age Group","Reference Type","Wear Period"),breakpoint = 70)
```
...
Ap |>
   filter(Day == 1) |> 
   filter(between(Gl,40,400)) |>
   system_agreement_fun(wider_name = NULL,long = F,ref = Reference, cgm = Gl,group_var = c("Age Group","Reference Type","12 Hour Interval","Ref. Glucose Level"),breakpoint = 70) |>
